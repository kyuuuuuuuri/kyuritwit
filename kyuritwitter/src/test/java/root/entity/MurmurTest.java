...
public class MurmurTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(Murmur.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_tuser() throws Exception {
        jdbcManager.from(Murmur.class).leftOuterJoin(tuser()).id(1).getSingleResult();
    }
}